...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, dropout, seq_len, embedding_dim):
        ...
        X = torch.arange(seq_len, dtype=torch.float32) # vector of indices up to seq_len
        ...
        untitled_var = torch.pow(10000, torch.arange(0, embedding_dim, 2, dtype=torch.float32) / embedding_dim) # [512]
